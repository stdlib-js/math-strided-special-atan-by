...
```javascript
import atanBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-atan-by@v0.2.3-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-atan-by@v0.2.3-esm/index.mjs';
```
